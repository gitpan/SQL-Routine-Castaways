...
# SQL::Routine::ByTree, and possibly other modules that are derived from it.

package # hide this class name from PAUSE indexer
t_SQL_Routine_ByTree;
use strict;
use warnings;
...
sub create_and_populate_model {
	...
	$application->create_child_node_tree( { 'NODE_TYPE' => 'routine', 
			...
			'return_var_type' => 'CURSOR', }, 'CHILDREN' => [ 
		...
		{ 'NODE_TYPE' => 'routine_stmt', 'ATTRS' => { 'id' => 1, 'stmt_type' => 'SPROC', 
			'call_sproc' => 'CURSOR_OPEN' }, },
	] } );
	...
	$application->create_child_node_tree( { 'NODE_TYPE' => 'routine', 
		...
		{ 'NODE_TYPE' => 'routine_stmt', 'ATTRS' => { 'id' => 2, 'stmt_type' => 'SPROC', 
			'call_sproc' => 'CURSOR_OPEN' }, },
	] } );
	...
	$application->create_child_node_tree( { 'NODE_TYPE' => 'routine', 
		...
		{ 'NODE_TYPE' => 'routine_stmt', 'ATTRS' => { 'id' => 3, 'stmt_type' => 'SPROC', 
			'call_sproc' => 'CURSOR_OPEN' }, },
	] } );
	...
	$application->create_child_node_tree( { 'NODE_TYPE' => 'routine', 
		...
		{ 'NODE_TYPE' => 'routine_stmt', 'ATTRS' => { 'id' => 4, 'stmt_type' => 'SPROC', 
			'call_sproc' => 'CURSOR_OPEN' }, },
	] } );
...
'<root>
	...
	<blueprints>
		...
		<application id="1">
			<view id="3" view_type="SINGLE" application="1" name="user_theme">
			...
			<routine id="1" routine_type="FUNCTION" application="1" name="get_user" return_var_type="CURSOR">
				<routine_arg id="1" routine="1" name="curr_uid" var_type="SCALAR" domain="9" />
				<view id="5" view_type="MATCH" routine="1" name="get_user" match_all_cols="1">
			...
			<routine id="2" routine_type="FUNCTION" application="1" name="get_pwp" return_var_type="CURSOR">
				...
				<view id="6" view_type="MATCH" routine="2" name="get_pwp" match_all_cols="1">
				...
				<routine_stmt id="2" routine="2" stmt_type="SPROC" call_sproc="CURSOR_OPEN" />
			</routine>
			<routine id="3" routine_type="FUNCTION" application="1" name="get_theme" return_var_type="CURSOR">
				<view id="7" view_type="MATCH" routine="3" name="get_theme" match_all_cols="1">
					<view_src id="10" view="7" name="m" match_view="3" />
				</view>
				<routine_stmt id="3" routine="3" stmt_type="SPROC" call_sproc="CURSOR_OPEN" />
			</routine>
			<routine id="4" routine_type="FUNCTION" application="1" name="get_person" return_var_type="CURSOR">
				<view id="4" view_type="MATCH" routine="4" name="get_person" match_all_cols="1">
					<view_src id="7" view="4" name="person" match_table="4" />
				</view>
				<routine_stmt id="4" routine="4" stmt_type="SPROC" call_sproc="CURSOR_OPEN" />
			</routine>
		</application>
	</blueprints>
	<tools />
