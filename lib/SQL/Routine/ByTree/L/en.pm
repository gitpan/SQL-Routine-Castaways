...
package SQL::Routine::ByTree::L::en;
use 5.006;
use strict;
use warnings;
use vars qw($VERSION);
...
messages generated by SQL::Routine::ByTree.>
...
my $CC = 'SQL::Routine::ByTree::Container';
my $CN = 'SQL::Routine::ByTree::Node';

my %text_strings = (
	'SRTBTR_C_CR_NODE_TREE_NO_ARGS' => 
		"$CC.create_node_tree(): missing argument",
	'SRTBTR_C_CR_NODE_TREE_BAD_ARGS' => 
		"$CC.create_node_tree(): invalid argument; it is not a hash ref, but rather is '{ARG}'",

	'SRTBTR_N_CR_NODE_TREE_NO_ARGS' => 
		"$CN.create_child_node_tree(): missing argument",
	'SRTBTR_N_CR_NODE_TREE_BAD_ARGS' => 
...
=head1 SYNOPSIS
	...
	use SQL::Routine::ByTree;

	# do work ...

	my $translator = Locale::KeyedText->new_translator( 
		['SQL::Routine::ByTree::L::', 'SQL::Routine::L::'], ['en'] );

	# do work ...

	eval {
		# do work with SQL::Routine::ByTree, which may throw an exception ...
	};
	...
	# continue working, which may involve using SQL::Routine::ByTree some more ...

=head1 DESCRIPTION

The SQL::Routine::ByTree::L::en Perl 5 module contains localization
data for SQL::Routine::ByTree.  It is designed to be interpreted by
Locale::KeyedText.

This class is optional and you can still use SQL::Routine::ByTree
...
=head2 get_text_by_key( MSG_KEY )
	...
	my $user_text_template = SQL::Routine::ByTree::L::en->get_text_by_key( 'foo' );
...
perl(1), Locale::KeyedText, SQL::Routine::ByTree.
